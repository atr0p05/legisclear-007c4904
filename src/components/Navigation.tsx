      ...
      <div className="container mx-auto px-6 py-4">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden lg:flex items-center space-x-3">
            ...
            {/* Demo Button - Only show when hero is not visible, always white */}
            <div className={`transition-all duration-500 transform ${
              ...
              <Button
                ...
                className="bg-white text-[#178ACB] hover:bg-gray-100 px-6 py-2 shadow-lg flex items-center gap-2 font-semibold transform hover:scale-105 hover:-translate-y-1 transition-all duration-300 group hover:shadow-xl"
              >
