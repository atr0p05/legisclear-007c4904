      ...
      <div className="container mx-auto px-6 text-center">
        <div className="max-w-5xl mx-auto text-white">
          <h2 className={`text-4xl md:text-5xl font-bold mb-8 transition-all duration-1000 ${
            ...
            Lead the Legal AI Revolution with RAG Technology
          </h2>
          ...
          <p className={`text-xl md:text-2xl mb-8 opacity-90 transition-all duration-1000 delay-300 ${
            ...
            that eliminates guesswork, accelerates insights, and delivers measurable ROI through verifiable AI 
            that legal professionals can trust and rely upon.
          </p>
          ...
          <p className={`text-lg mb-12 opacity-80 transition-all duration-1000 delay-500 ${
            ...
            Join the growing community of legal innovators leveraging LegisClear's cutting-edge RAG technology. 
            Experience firsthand how our platform transforms practice efficiency, dramatically reduces administrative overhead, 
            accelerates research capabilities, and delivers unprecedented ROI—all through instant access 
            to comprehensive, source-verified legal intelligence that you can confidently act upon.
          </p>
          ...
          <div ref={statsRef} className="grid md:grid-cols-3 gap-8 mb-12">
            <div className={`p-6 bg-white/10 backdrop-blur-md rounded-lg transform transition-all duration-1000 hover:scale-105 hover:bg-white/15 ${
              ...
              <p className="opacity-90">Faster RAG-powered research than traditional methods with complete verifiability</p>
            </div>
            ...
            <div className={`p-6 bg-white/10 backdrop-blur-md rounded-lg transform transition-all duration-1000 hover:scale-105 hover:bg-white/15 ${
              ...
              <p className="opacity-90">Reduction in non-billable time through intelligent RAG automation</p>
            </div>
            ...
            <div className={`p-6 bg-white/10 backdrop-blur-md rounded-lg transform transition-all duration-1000 hover:scale-105 hover:bg-white/15 ${
              ...
              <p className="opacity-90">First-year ROI achieved by firms leveraging advanced RAG technology</p>
            </div>
          </div>
          ...
          <div className={`p-8 bg-white/10 backdrop-blur-md rounded-lg transform transition-all duration-1000 hover:bg-white/15 ${
            ...
            <h3 className="text-2xl font-bold mb-4">Our Vision: Pioneering RAG Excellence for Legal Professionals</h3>
            <p className="text-lg opacity-90">
              To revolutionize legal practice by empowering every legal professional and academic institution 
              with verifiable, RAG-driven intelligence that eliminates uncertainty and accelerates excellence. 
              We believe that by grounding AI in truth, transparency, and continuous legal knowledge, 
              we can elevate the standard of legal service delivery, accelerate discovery, and foster more just outcomes. 
              <strong>LegisClear LLC: Where precision meets intelligence, powered by the next generation of legal AI.</strong>
            </p>
          </div>
        </div>
      </div>
